...
window.I18N = {
  zh: {
    ...
    series_progress: '篇',
    series_all: '查看全系列 →',
    series_featured: '完整教程',
    series_start: '开始学习 →',
    series_for: '适合谁',
    series_routes: '三条阅读路线',
    series_contents: '十篇教程',
    ...
    artifacts: [
      ...
      { label: 'AI 求职每日一课 · 12 周从会调用到会上生产', href: '/tech-notes/', date: '2026-08-24' },
  ...
  en: {
    ...
    series_featured: 'Complete course',
    series_start: 'Start learning →',
    series_for: 'Who it is for',
    series_routes: 'Three reading paths',
    series_contents: 'Ten tutorials',
    ...
    artifacts: [
      ...
      { label: 'AI Career Daily · a 12-week production-ready path', href: '/tech-notes/', date: '2026-08-24' },
